...
import drollcaller.checkers.CheckerRunner
...
class Monitor(
        private val checkers: List<drollcaller.checkers.Checker>,
        private val notifiers: List<drollcaller.notifiers.Notifier>,
    ...
    private var previousResults: MutableMap<drollcaller.checkers.Checker, drollcaller.checkers.CheckResult> =
            HashMap<drollcaller.checkers.Checker, drollcaller.checkers.CheckResult>()
    private var currentResults: MutableMap<drollcaller.checkers.Checker, drollcaller.checkers.CheckResult> =
            HashMap<drollcaller.checkers.Checker, drollcaller.checkers.CheckResult>()
    ...
    private fun compareProblems(
            previousResults: Map<drollcaller.checkers.Checker, drollcaller.checkers.CheckResult>,
            currentResults: Map<drollcaller.checkers.Checker, drollcaller.checkers.CheckResult>
    ): Boolean {
